...
class IntegratedDataPipeline:
    ...
    def __init__(self):
        ...
        self.csv_uploader_path = (
            "/home/jc/Documents/Horse-race-ai-v2.01/corrected_csv_uploader.py"
        )
    ...
    async def import_csv_data(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print(
                    f"   📊 Output: {result.stdout.split('SUMMARY:')[-1].split()[0] if 'SUMMARY:' in result.stdout else 'Import completed'}"
                )
                return True
            else:
    ...
    async def run_reward_analysis(self):
        ...
        try:
            ...
            reward_analyzer_path = Path(
                "/home/jc/Documents/Horse-race-ai-v2.01/cleanup_temp/scripts/ai_reward_analyzer.py"
            )
            active_reward_path = Path(
                "/home/jc/Documents/Horse-race-ai-v2.01/ai_reward_analyzer.py"
            )
    ...
    async def update_pipeline_status(self):
        ...
        try:
            ...
            status_file = Path(
                "/home/jc/Documents/Horse-race-ai-v2.01/integrated_pipeline_status.json"
            )
            import json
