...
class TestUploadSystemBasics(unittest.TestCase):
    ...
    def test_import_upload_modules(self):
        ...
        try:
            ...
            self.assertEqual(
                len(column_types), 2
            )  # Should return (integer_cols, float_cols)
    ...
    def test_data_conversion_edge_cases(self):
        ...
        try:
            from safe_upload_all import convert_fav_position, convert_uk_weight
    ...
    def test_column_type_definitions(self):
        ...
        try:
            ...
            for table in test_tables:
                ...
                print(
                    f"✅ Column types for {table}: {len(integer_cols)} int, {len(float_cols)} float"
                )
