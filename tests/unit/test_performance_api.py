...
class TestPerformanceAPI:
    ...
    def test_get_performance_summary_success(self, mock_connect, performance_api, 
                                           mock_db_connection, sample_performance_data):
        """Test successful performance summary retrieval"""
        mock_conn, mock_cursor = mock_db_connection
        mock_connect.return_value = mock_conn
        mock_cursor.fetchone.return_value = sample_performance_data[0]
        mock_cursor.fetchall.return_value = []  # For confidence breakdown and daily performance
    ...
    @patch('performance_api.psycopg2.connect')
    def test_get_performance_summary_database_error(self, mock_connect, performance_api):
    ...
    @patch('performance_api.psycopg2.connect')
    def test_get_recent_selections_success(self, mock_connect, performance_api,
                                         mock_db_connection, sample_selections_data):
    ...
    @patch('performance_api.psycopg2.connect')
    def test_get_recent_selections_with_limit(self, mock_connect, performance_api,
                                            mock_db_connection):
    ...
    def test_decimal_to_float_conversion(self, performance_api, sample_performance_data):
...
class TestPerformanceAPIBoundaryConditions:
    ...
    def test_sql_injection_protection(self, performance_api):
        ...
        with patch('performance_api.psycopg2.connect') as mock_connect:
            ...
            result = performance_api.get_recent_selections(limit="10; DROP TABLE betting_performance_tracker;")
