...
class TestWorkingAISelectionMigrator:
    ...
    def test_migrate_ai_selections_success(self, mock_connect, mock_db_connections,
        ...
        # Setup mock data
        mock_db_connections['source_cursor'].fetchall.return_value = sample_ai_selections
        mock_db_connections['target_cursor'].fetchone.return_value = None  # No existing record
    ...
    @patch('working_ai_migrator.psycopg2.connect')
    def test_migrate_with_existing_records(self, mock_connect, mock_db_connections,
                                         sample_ai_selections):
