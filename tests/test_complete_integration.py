...
class TestCompleteIntegration(unittest.TestCase):
    ...
    def test_docker_organization_complete(self):
        ...
        dockerfiles = ["Dockerfile.data-processing", "Dockerfile.pipeline-management"]
    ...
    def test_data_integrity_issues_identified(self):
        ...
        cmd = [
            sys.executable,
            str(self.project_root / "tools/testing/database_relationships_test.py"),
        ]
    ...
    def test_pipeline_files_moved_correctly(self):
        ...
        # Check web app files
        web_app_files = ["docker/web_app/app.py", "docker/web_app/main.py"]
    ...
    def test_old_files_removed_from_root(self):
        ...
        for file_name in removed_files:
            ...
            self.assertFalse(
                file_path.exists(), f"{file_name} should be removed from root"
            )
    ...
    def test_integration_tests_pass(self):
        ...
        try:
            ...
            self.assertEqual(
                result.returncode, 0, "Docker organization tests should pass"
            )
