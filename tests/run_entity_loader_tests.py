...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["all", "unit", "integration", "performance", "report"], 
                       default="all", help="Test mode to run")
    parser.add_argument("--validate", action="store_true", help="Validate test environment first")
