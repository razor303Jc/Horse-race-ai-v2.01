...
class TestWebAppIntegration:
    ...
    def test_api_endpoints_from_webapp(self):
        ...
        endpoints = [
            ...
            f"{self.API_BASE}/recent?limit=10"
        ]
...
class TestUserWorkflows:
    ...
    def test_filtering_workflow(self):
        ...
        print(f"✅ Filtering data available: {confidence_count} confidence levels, "
    ...
    def test_time_period_analysis_workflow(self):
        ...
        for i in range(1, len(period_data)):
            ...
            error_msg = (f"Longer period should have more predictions: "
...
class TestSystemPerformance:
    ...
    def test_response_times_under_load(self):
        ...
        endpoints = [
            f"{self.API_BASE}/performance",
            f"{self.API_BASE}/recent?limit=25"
        ]
        ...
        if successful:
            ...
            perf_msg = (f"✅ Performance under load: {avg_time:.2f}s avg, "
...
class TestDataIntegrity:
    ...
    def test_business_logic_validation(self):
        ...
        if total_predictions > 0:
            ...
            accuracy_error = ("Accuracy calculation incorrect: "
