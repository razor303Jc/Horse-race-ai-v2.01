...
class TestAISelectionsAPIEndpoints:
    ...
    def test_get_ai_selections_performance_success(self, mock_perf_api, client,
                                                  mock_performance_api_success):
        """Test successful performance API endpoint"""
        mock_perf_api.get_performance_summary.return_value = mock_performance_api_success
    ...
    @patch('api_server_enhanced.performance_api')
    def test_get_recent_ai_selections_success(self, mock_perf_api, client,
                                            mock_recent_selections_success):
        """Test successful recent selections API endpoint"""
        mock_perf_api.get_recent_selections.return_value = mock_recent_selections_success
    ...
    @patch('api_server_enhanced.performance_api')
    def test_get_recent_ai_selections_custom_limit(self, mock_perf_api, client,
                                                  mock_recent_selections_success):
    ...
    @patch('api_server_enhanced.performance_api')
    def test_get_recent_ai_selections_default_limit(self, mock_perf_api, client,
                                                   mock_recent_selections_success):
    ...
    @patch('api_server_enhanced.performance_api')
    def test_get_ai_selections_dashboard_success(self, mock_perf_api, client,
                                               mock_performance_api_success,
                                               mock_recent_selections_success):
