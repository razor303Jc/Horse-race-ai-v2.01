...
def run_caching_tests():
    ...
    tests = [
        ...
        (
            ...
            lambda: test_suite.test_cache_performance_tracking(cache_manager),
        ),
        (
            "Race Feature Caching",
            lambda: test_suite.test_race_feature_caching(cached_fe),
        ),
        (
            "FE Performance",
            lambda: test_suite.test_feature_engineering_performance(cached_fe),
        ),
        (
            "Memory Management",
            lambda: test_suite.test_cache_memory_usage(cache_manager),
        ),
    ]
