...
class TestDatabaseIntegration:
    ...
    def test_betting_performance_tracker_schema(self, mock_db_connection):
        ...
        with patch('psycopg2.connect', return_value=conn):
            ...
            essential_columns = [
                'race_id', 'horse_name', 'profit_loss', 'roi_percentage'
            ]
    ...
    @pytest.mark.integration
    def test_insert_betting_performance_record(self, mock_db_connection,
                                             sample_betting_performance_data):
...
class TestDatabaseConstraints:
    ...
    def test_primary_key_constraint(self, mock_db_connection):
        ...
        with patch('psycopg2.connect', return_value=conn):
            with pytest.raises(psycopg2.IntegrityError):
                cursor.execute("INSERT INTO betting_performance_tracker (id, race_id) VALUES (1, 123)")
    ...
    def test_not_null_constraints(self, mock_db_connection):
        ...
        with patch('psycopg2.connect', return_value=conn):
            with pytest.raises(psycopg2.IntegrityError):
                cursor.execute("INSERT INTO betting_performance_tracker (race_id) VALUES (NULL)")
