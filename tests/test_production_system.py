...
from horse_racing_ai.data_feeds.live_race_data_api import LiveRaceDataAPI, RaceDataIntegrator
from horse_racing_ai.betting.betting_exchange_api import BetfairAPI, BettingExchangeIntegrator
...
class TestBettingExchangeAPI(unittest.TestCase):
    ...
    def test_risk_management_validation(self):
        ...
        self.assertFalse(self.integrator._validate_stake(75.0, "single"))  # Exceeds max single
        
        # Test daily exposure
        self.integrator.daily_stake_total = 150.0
        self.assertTrue(self.integrator._validate_stake(40.0, "daily"))
        self.assertFalse(self.integrator._validate_stake(60.0, "daily"))  # Would exceed daily max
