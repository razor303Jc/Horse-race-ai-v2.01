...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "api: Web API endpoint tests"
    )
...
def test_environment():
    ...
    os.environ["TEST_DB_NAME"] = os.getenv("TEST_DB_NAME", "test_advanced_racing_metrics_db")
    os.environ["TEST_DB_USER"] = os.getenv("TEST_DB_USER", "horse_racing")
    os.environ["TEST_DB_PASSWORD"] = os.getenv("TEST_DB_PASSWORD", "secure_password_123")
