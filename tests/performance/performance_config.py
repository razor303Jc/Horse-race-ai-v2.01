...
TEST_DATA_CONFIG = {
    ...
    'sample_courses': [
        'Cheltenham', 'Aintree', 'Ascot', 'Newmarket', 'York',
        'Goodwood', 'Epsom', 'Doncaster', 'Chester', 'Bath'
    ],
    
    'sample_classes': [
        'Class 1', 'Class 2', 'Class 3', 'Class 4', 'Class 5',
        'Listed', 'Group 1', 'Group 2', 'Group 3', 'Handicap'
    ]
}
...
class PerformanceAnalyzer:
    ...
    @staticmethod
    def assess_performance_grade(actual_value: float, threshold: float, 
...
def get_performance_config():
    ...
    if 'PERF_TEST_ITERATIONS' in os.environ:
        config['execution']['default_iterations'] = int(os.environ['PERF_TEST_ITERATIONS'])
...
if __name__ == "__main__":
    ...
    print(f"   🎯 Success rate threshold: {config['thresholds']['success_rate_min']:.1%}")
