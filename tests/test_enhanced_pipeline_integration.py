...
from tools.automation.enhanced_pipeline_integration import (
    EnhancedPipelineIntegration
)
from tools.ml_training.time_aware_ml_optimizer import (
    TimeAwareMLOptimizer
)
...
class TestEnhancedPipelineIntegration:
    ...
    def test_run_enhanced_pipeline_success_with_ml(
        self, mock_ml_optimize, mock_should_trigger, 
        mock_data_check, mock_subprocess, enhanced_pipeline
    ):
    ...
    def test_run_enhanced_pipeline_success_without_ml(
        self, mock_should_trigger, mock_data_check, 
        mock_subprocess, enhanced_pipeline
    ):
    ...
    def test_send_pipeline_completion_notification_disabled(
...
class TestEnhancedPipelineIntegrationScenarios:
    ...
    def test_overnight_processing_scenario(self, tmp_path):
        ...
        with patch.object(
            ...
            data_status = {
                "has_new_data": True,
                "data_tables": {"result_races": 10000}
            }
