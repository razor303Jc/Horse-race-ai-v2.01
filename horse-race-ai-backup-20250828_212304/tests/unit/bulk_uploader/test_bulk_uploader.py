...
class TestDataCleaner:
    ...
    def test_clean_race_results_fields(self):
        ...
        df = pd.DataFrame({
            'finish_position': ['1st', '2nd', '3rd', 'PU', 'F']
        })
...
class TestColumnMappings:
    ...
    def test_column_mappings_structure(self):
        ...
        for table in expected_tables:
            ...
            assert 'csv_to_db' in CSV_COLUMN_MAPPINGS[table], f"csv_to_db missing for {table}"
    ...
    def test_horses_id_mapping_fix(self):
        ...
        if 'results_horses' in CSV_COLUMN_MAPPINGS:
            ...
            assert horses_mapping['id'] == 'horse_id', "CSV 'id' should map to 'horse_id'"
    ...
    def test_case_sensitivity_fix(self):
        ...
        if 'jockeys_stats' in CSV_COLUMN_MAPPINGS:
            ...
            assert jockeys_mapping['uptodate'] == 'uptodate', "uptodate should map to uptodate"
        ...
        if 'trainers_stats' in CSV_COLUMN_MAPPINGS:
            ...
            assert trainers_mapping['uptodate'] == 'uptodate', "uptodate should map to uptodate"
...
class TestBulkUploader:
    ...
    def test_file_discovery(self):
        ...
        test_files = {
            ...
            'records.csv': pd.DataFrame({'horse_name': ['Test Horse'], 'position': [1]})
        }
...
class TestBulkUploaderPerformance:
    ...
    def test_large_file_processing(self):
        ...
        assert processing_time < 1.0, f"Large file processing too slow: {processing_time}s"
