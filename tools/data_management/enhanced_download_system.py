...
class DatabaseManager:
    ...
    def record_download(self, download_date: str, source_type: str, 
                       file_category: str, filename: str, 
                       file_size: int, record_count: Optional[int] = None) -> int:
...
class EnhancedDownloadSystem:
    ...
    def simulate_download(self, download_date: str = None) -> Dict:
        ...
        downloads = [
            ("cards_data", "races", "races.csv", "race_id,race_name,track,distance\n1001,Test Race,Flemington,1600m\n1002,Another Race,Randwick,2000m"),
            ("cards_data", "horses", "horses.csv", "horse_id,horse_name,age,weight\nH001,Lightning Bolt,4,58.5\nH002,Thunder Strike,5,57.0"),
            ("cards_data", "jockeys_stats", "jockeys_stats.csv", "jockey_id,jockey_name,wins,rides\nJ001,J.Smith,15,45\nJ002,M.Jones,12,38"),
            ("results_data", "races", "races.csv", "race_id,race_result,winning_time\n1001,H001,1:36.2\n1002,H002,2:01.8")
        ]
        ...
        for source_type, file_category, filename, content in downloads:
            ...
            download_id = self.db_manager.record_download(
                download_date, source_type, file_category, 
    ...
    def complete_download_workflow(self, download_date: str = None) -> Dict:
        ...
        workflow_result["success"] = archive_result.get("success", True) and download_result.get("success", True)
    ...
    def show_data_by_date(self, days: int = 7) -> Dict:
        ...
        for day_data in data_by_date:
            ...
            size_mb = day_data["total_size_bytes"] / 1024 / 1024 if day_data["total_size_bytes"] else 0
