...
Automated daily processing from data download (06:01) to contextual analysis
...
class DailyPipelineOrchestrator:
    ...
    def detect_first_race_time_enhanced(self) -> Optional[datetime]:
        ...
        try:
            ...
            data_sources = [
                {
                    "path": "project_root / 'data' / daily_downloads/cards_project_root / 'data' / races/races.csv",
                    "date_columns": ["Date", "date", "race_date"],
                    "time_columns": ["race_time", "time", "start_time", "off_time"],
                    "source": "cards_data",
                },
                {
                    "path": "project_root / 'data' / daily_downloads/results_project_root / 'data' / races/races.csv",
                    "date_columns": ["Date", "date", "race_date"],
                    "time_columns": ["race_time", "time", "start_time", "off_time"],
                    "source": "results_data",
                },
                {
                    "path": "project_root / 'data' / daily_downloads/cards_project_root / 'data' / racecard_details/racecard_details.csv",
                    "date_columns": ["Date", "date", "race_date"],
                    "time_columns": ["race_time", "time", "start_time", "off_time"],
    ...
    async def verify_download_completion(self) -> Dict:
        ...
        try:
            ...
            data_dir = Path("project_root / 'data' / daily_downloads")
...
def main():
    ...
    if args.run_now:
        ...
        print("📈 06:01 - Race Trends Analysis")
