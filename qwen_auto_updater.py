...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/qwen_auto_updater.log"),
...
class QwenAutoUpdater:
    ...
    def __init__(self, config_path: str = "config/qwen_updater_config.yaml"):
...
def main():
    ...
    parser.add_argument("--config", default="config/qwen_updater_config.yaml", help="Config file path")
