        ...
        try:
            ...
            with psycopg2.connect(
                ...
                with conn.cursor() as cursor:
                    ...
                    expected_tables = ['horses_entity', 'jockeys_entity', 'trainers_entity']
...
def main():
    ...
    parser.add_argument('--create-all', action='store_true', 
                       help='Create all entity tables')
    parser.add_argument('--create-horses', action='store_true',
                       help='Create horses entity table')
    parser.add_argument('--create-jockeys', action='store_true',
                       help='Create jockeys entity table')
    parser.add_argument('--create-trainers', action='store_true',
                       help='Create trainers entity table')
    parser.add_argument('--database', default='results',
                       help='Target database (default: results)')
    parser.add_argument('--verify', action='store_true',
                       help='Verify existing tables')
    ...
    if success and (args.create_all or args.create_horses or args.create_jockeys or args.create_trainers):
