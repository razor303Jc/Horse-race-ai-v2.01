#!/usr/bin/env python3
"""
🔴 LIVE TEST MONITOR - Auto-Downloader at 11:01
...
class LiveTestMonitor:
    """Monitor the live test performance at 11:01"""

    def __init__(self):
        self.test_start_time = "11:01"
    ...
    def get_time_until_test(self):
        """Calculate time until 11:01 test"""
        now = datetime.now()
    ...
    async def monitor_live_test(self):
        ...
        while True:
            ...
            # Check if we're in the test window (11:01 - 20:30)
...
async def main():
    ...
    print("=" * 40)
    print("Auto-downloader scheduled for 11:01 BST")
