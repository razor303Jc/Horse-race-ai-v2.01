...
def update_enhanced_api_server_config():
    ...
    config_path = Path("/home/jc/Documents/Horse-race-ai-v2.05/config/postgresql_api_config.json")
...
"""
    ...
    script_path = Path("/home/jc/Documents/Horse-race-ai-v2.05/scripts/migrate_api_to_postgresql.py")
