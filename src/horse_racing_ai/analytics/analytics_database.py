...
class AnalyticsDatabase:
    ...
    def record_prediction_result(
        ...
        try:
            ...
            logger.info(f"Recorded prediction result for {horse_id} in race {race_id}")
    ...
    def get_prediction_results_by_date_range(
        ...
        try:
            ...
            logger.error(f"Error retrieving prediction results for date range: {e}")
            return pd.DataFrame()
        ...
        try:
            ...
            with self.get_connection() as conn:
                with conn.cursor() as cursor:
                    ...
                    strike_rate = (
                        (winning_bets / total_bets * 100) if total_bets > 0 else 0
                    )
