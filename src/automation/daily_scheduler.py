...
from automation.respectful_auto_downloader import (
    DownloadConfig,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Daily Scheduler for Respectful Auto Downloader"
    )
    parser.add_argument("--config", type=str, help="Path to configuration file")
    parser.add_argument(
        "--run-now",
        action="store_true",
        help="Run download immediately instead of scheduling",
    )
