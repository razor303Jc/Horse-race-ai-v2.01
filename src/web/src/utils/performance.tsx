...
// Note: These imports are commented out as the components may not exist yet
// const AdvancedBettingDashboard = lazy(() => import('../betting/AdvancedBettingDashboard'));
// const AdvancedAnalyticsDashboard = lazy(() => import('../analytics/AdvancedAnalyticsDashboard'));
// const UserManagementDashboard = lazy(() => import('../user/UserManagementDashboard'));
// const PersonalizationEngine = lazy(() => import('../user/PersonalizationEngine'));
...
// Note: These exports are commented out as the components may not exist yet
// export const OptimizedBettingDashboard = withLazyLoading(AdvancedBettingDashboard);
// export const OptimizedAnalyticsDashboard = withLazyLoading(AdvancedAnalyticsDashboard);
// export const OptimizedUserDashboard = withLazyLoading(UserManagementDashboard);
// export const OptimizedPersonalizationEngine = withLazyLoading(PersonalizationEngine);
